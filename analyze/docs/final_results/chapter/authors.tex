...
Der Within-module degree eines Autors ist durch folgende Formel \cite[p.18]{Within-module-form} bestimmt: \\
...
Der Participation coefficient eines Autors ist durch folgende Formel \cite[p.18]{Participation-coefficient-form} bestimmt: \\
